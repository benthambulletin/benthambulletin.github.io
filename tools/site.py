...
.dateline{text-align:center;font-family:'AR';font-weight:700;font-size:1.1rem;letter-spacing:.14em;text-transform:uppercase}
...
.sec{text-align:center;font-family:'AR';font-weight:700;font-size:.95rem;letter-spacing:.3em;text-transform:uppercase;margin:0 0 .9rem}
...
.town .n{font-family:'AR';font-weight:700;font-size:.62rem;letter-spacing:.14em;text-transform:uppercase;color:var(--teal)}
...
.ledger .txt{flex:1}
.wire{display:flex;gap:.7rem;padding:.55rem 0;border-bottom:1px solid #d8c795}
...
.wire h3{font-family:'PF';font-weight:700;font-size:1.3rem;margin:0 0 .15rem;line-height:1.2}
...
.arch li{display:flex;gap:.9rem;align-items:center;padding:.7rem 0;border-bottom:1px solid #d8c795}
