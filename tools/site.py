...
:root{--paper:#fffdf8;--ink:#1c170f;--red:#c8302f;--teal:#0e8a8a;--gold:#e8b100;--soft:#5f5238;--rule:#d9d0bb}
*{box-sizing:border-box}
html{background:#efe9dc;-webkit-text-size-adjust:100%}
...
.ledger .txt{flex:1}
.wire{display:flex;gap:.7rem;padding:.55rem 0;border-bottom:1px solid #e6dfcc}
...
.star{display:flex;gap:.6rem;padding:.35rem 0;border-bottom:1px solid #e6dfcc}
...
.tbl td{padding:.3rem .3rem;border-bottom:1px solid #e6dfcc}
...
.arch li{display:flex;gap:.9rem;align-items:center;padding:.7rem 0;border-bottom:1px solid #e6dfcc}
